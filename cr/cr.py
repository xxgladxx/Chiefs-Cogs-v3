...
class ClashRoyaleCog(commands.Cog):
    ...
    async def profile(self, ctx, member=None):
        ...
        await ctx.send(f"{}, the command is under development. Contact <@698376874186768384> regarding the updates. Notification will be sent in <#822770263371546635> once it's available.".format(ctx.author.mention))
