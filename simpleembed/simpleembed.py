...
class SimpleEmbed(commands.Cog):
	...
	async def selfroles(self, ctx):
		embed = discord.Embed(title="Invite", url = "https://discord.gg/nKarkppYsy", description = "Self Roles Menu", color = 0x00ff59)
		...
		embed.set_thumbnail(url="https://media.discordapp.net/attachments/754780357349605467/760462448846831646/image1.png?width=473&height=473")
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":bluecrown:", value="Clash Royale Official news", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":api:", value="RoyaleAPI Official updates", inline =False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":gc:", value="Get notified when someone gets GC 12 wins", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":cc:", value= "Get notified when someone gets CC 12 wins", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":moneyop:", value="Get notified when a Heist begins", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":video_game:", value="Get notified when a Roulette match begins", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":battle:", value="Get pinged when someone starts a duel", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=f":cashbag:", value="Casino role, maybe you can win allin, MAYBE!", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.set_footer(text="Bot by Gladiator#0004", icon_url="https://images-ext-1.discordapp.net/external/kYJx8YK6XrdnbhUQEHHbFtsmN4X2ga4LbzgVMFllKi8/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/698376874186768384/a_d545d6bab43dd8e041268f1d51fa4199.gif?width=473&height=473")
		await ctx.send(embed = embed)
