...
class SimpleEmbed(commands.Cog):
	...
	async def selfroles(self, ctx):
		...
		embed.set_thumbnail(url="https://media.discordapp.net/attachments/754780357349605467/760462448846831646/image1.png?width=473&height=473")
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200B", value="Clash Royale Official news {}".format('<:bluecrown:843728805918015528>'), inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200b", value="RoyaleAPI Official updates {}".format('<:api:843728820887748618>'), inline =False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200b", value="Get notified when someone gets GC 12 wins {}".format('<:gc:843728907160649769>'), inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200b", value= "Get notified when someone gets CC 12 wins {}".format('<:cc:843728914856935445>'), inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200b", value="Get notified when a Heist begins {}".format('<:moneyop:843728850399133708>'), inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name=":video_game:", value="Get notified when a Roulette match begins", inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200b", value="Get pinged when someone starts a duel {}".format('<:battle:843728835773988884>'), inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.add_field(name="\u200b", value="Casino role, maybe you can win allin, MAYBE! {}".format('<:cashbag:843728870594707496>'), inline=False)
		embed.add_field(name="\u200B", value="\u200B", inline =False)
		embed.set_footer(text="Bot by Gladiator#0004", icon_url="https://images-ext-1.discordapp.net/external/kYJx8YK6XrdnbhUQEHHbFtsmN4X2ga4LbzgVMFllKi8/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/698376874186768384/a_d545d6bab43dd8e041268f1d51fa4199.gif?width=473&height=473")
		await ctx.send(embed = embed)
