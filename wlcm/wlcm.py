  ...
  #  @commands.Cog.listener()
   # async def on_member_join(self, member : discord.Member) -> None:
    ...
    async def approve(self, ctx, member : discord.Member = None):
        ...
        embed.add_field(name=f"We're more than happy to have you approved as a Chief! \n Please click the link below to join our clan.", value=f"<:star:827893695047139348> [\u2022\u2022\u2022](https://link.clashroyale.com/en?clanInfo?id=YGGQR0CV%27")
